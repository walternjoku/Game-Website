...
<body>
    ...
    <video class="vid" width="100%" height="400px" autoplay controls>
        <source src="Modern Warfare II.mp4" type="video/mp4">
        <source src="Modern Warfare II.ogg" type="video/ogg">
        <source src="Modern Warfare II.webm" type="video/webm">
    </video>
    <footer>
